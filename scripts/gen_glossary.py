...
<!-- CTA -->
<section class="lp-sec lp-tight">
  <div class="wrap end-cta">
    <div><h2>These numbers should calculate themselves</h2><p>Merik computes payable days, loss of pay and payslips from the attendance your team already records, so the terms above stop being things you work out by hand.</p></div>
    <div class="end-cta-a"><a class="btn btn-primary" href="/request-access?from=/glossary">Request your workspace</a><a class="lp-link" href="/blog/">Read the guides</a></div>
  </div>
</section>
{footer()}
