...
<section class="lp-sec lp-tight">
  <div class="wrap end-cta">
    <div><h2>Run your workforce the simple way</h2><p>Request your free company workspace and bring employees, attendance, leave, payroll and tasks together.</p></div>
    <div class="end-cta-a"><a class="btn btn-primary" href="/request-access?from=/blog/">Request your workspace</a><a class="lp-link" href="/features">Explore features</a></div>
  </div>
</section>
{footer()}
